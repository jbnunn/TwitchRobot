...
endpoint = '<REPLACE-WITH-YOUR-AWS-IOT-ENDPOINT>' # https://docs.aws.amazon.com/iot/latest/developerguide/sdk-tutorials.html
...
createMQTTClient = AWSIoTMQTTClient("create-robot-raspberrypi")
createMQTTClient.configureEndpoint(endpoint, 443)
createMQTTClient.configureCredentials("~/certs/AmazonRootCA1.crt", "~/certs/<REPLACE>.private.key", "~/certs/<REPLACE>.cert.pem")
