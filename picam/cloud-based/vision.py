...
* Do on-board classification,
* Send images to AWS Rekognition for 
    * classification ()
    * face detection (https://docs.aws.amazon.com/rekognition/latest/dg/API_DetectFaces.html)
* ...
...
class Vision():
    ...
    def detect_faces(self):
        ...
        image.save('annotated_' + self.image)
        self.image = image
